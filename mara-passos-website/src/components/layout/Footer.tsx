        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex gap-4">
              {/* Facebook */}
              <a href="https://www.facebook.com/estudiomarapassos" aria-label="Facebook" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-mara-orange hover:text-white transition-colors">
              ...
              {/* WhatsApp */}
              <a href="https://api.whatsapp.com/send/?phone=5511972405722&text&type=phone_number&app_absent=0" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-mara-orange hover:text-white transition-colors">
              ...
              {/* Instagram */}
              <a href="https://instagram.com/estudiomarapassos/" aria-label="Instagram" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-mara-orange hover:text-white transition-colors">
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/@estudiomarapassos2255/featured" aria-label="YouTube" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-mara-orange hover:text-white transition-colors">
          ...
          <div className="w-full h-64 lg:h-full min-h-[220px] rounded-xl overflow-hidden border border-white/10 shadow-lg relative group">
            <iframe
              ...
              loading="lazy"
              title="Mapa do Estúdio Mara Passos"
      ...
      <div className="bg-[#111111] py-6 border-t border-white/5">
        <div className="container mx-auto px-6 text-center flex flex-col gap-2">
          ...
          <p className="text-xs text-gray-600 font-medium">
            Desenvolvido por <a href="https://le-solutions.vercel.app/" target="_blank" rel="noopener noreferrer" className="hover:text-mara-orange transition-colors">L.E. Solutions</a>.
          </p>
        </div>
      </div>
    </footer>
