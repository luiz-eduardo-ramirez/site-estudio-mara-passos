...
const instrumentsList = [
  ...
  { nome: "Teoria Musical", desc: "A base teórica e leitura de partituras.", detalhes: "Desmistificando a partitura! Aprenda as regras que formam a música de um jeito leve. Harmonia, percepção, escalas e ditados musicais para fortalecer sua base como músico.", icone: BookOpen, imagem: "/images/teoria.png" },
  { nome: "Ukelelê", desc: "Prático, divertido e fácil de aprender.", detalhes: "O instrumento perfeito para quem quer resultados rápidos e divertidos. Aprenda acordes práticos, batidas variadas e comece a tocar suas músicas favoritas em poucas semanas.", icone: Music, imagem: "/images/ukelele.png" },
  { nome: "Violão", desc: "Acordes, dedilhados e repertório popular.", detalhes: "Do primeiro acorde à fluência no braço do instrumento. Nossas aulas de violão são adaptáveis ao seu estilo preferido, focando em dedilhados, batidas e harmonia prática.", icone: Headphones, imagem: "/images/violao.png" },
  { nome: "Violino", desc: "A arte e elegância das cordas friccionadas.", detalhes: "Com uma metodologia paciente e atenciosa, guiamos você pelos desafios da afinação, postura correta e manuseio do arco, revelando a beleza e a emoção do violino.", icone: Music, imagem: "/images/violino.png" },
];
